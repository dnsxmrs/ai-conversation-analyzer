    ...
    return (
        <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
            <style>{`
                ...
                /* ── Warm amber glow — rhymes with sign-in ── */
                .fp-page::after {
                    content: '';
                    position: fixed;
                    top: -140px;
                ...
                .fp-fi1 { animation: fp-fade-up 0.5s ease both; }
                .fp-fi2 { animation: fp-fade-up 0.5s 0.07s ease both; opacity: 0; }
            `}</style>

            <div className="fp-page" />

            {/* Form */}
            <main className="fp-fi2 relative z-10 flex-1 flex items-center justify-center px-8 py-8">
