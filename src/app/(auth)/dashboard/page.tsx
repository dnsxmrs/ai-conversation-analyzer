...
import { NewAnalysisLink, UploadConversationLink } from "./dashboard-client";
    ...
    return (
        <div className="container mx-auto px-4 py-10 max-w-7xl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
                <div>
                    <h1 className="text-2xl sm:text-[28px] font-semibold tracking-tight text-neutral-900 dark:text-white mb-1.5">Your Conversations</h1>
